#!/usr/bin/env python3
"""Unified benchmark runner for SpAdd."""
...
KERNELS_DIR = BENCHMARKS_DIR / "kernels" / "benchmark" / "spadd"
TACO_EXE = BENCHMARKS_DIR / "taco" / "build" / "spadd_taco"
DEFAULT_OUTPUT = BENCHMARKS_DIR / "results" / "csv" / "benchmark_spadd.csv"
DEFAULT_FAILED = BENCHMARKS_DIR / "results" / "csv" / "benchmark_spadd_failed.csv"
DEFAULT_PAIRS = BENCHMARKS_DIR / "results" / "csv" / "spadd_pairs_used.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run unified SpAdd benchmark")
...
def main() -> int:
    ...
    if not pairs:
        raise ValueError("No compatible matrix pairs found for spadd")
